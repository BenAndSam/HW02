...
/** Remove an entry
	...
	*/
string Phone_Directory::remove_entry(const string& name) // COMPLETED BY SAM HOLZER
{ 
	//Determine if the name exists in the directory
	int index = find(name);

	//If the name exists, the function will receive the name, overwrite the array to remove the
